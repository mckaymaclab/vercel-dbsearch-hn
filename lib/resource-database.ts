...
export const resourceDatabase: LibraryResource[] = [
    ...
    url: "https://byui.idm.oclc.org/login?url=https://pubs.acs.org/",
        moreInfo:
            "ACS Publications is a leader in providing access to chemistry-related information and research through peer-reviewed journal and e Books. Research from Nobel Prize winners in Chemistry and Medicine have been published in ACS Publications in journals and e Books. Available as an App:&nbsp;&nbsp; &nbsp;&nbsp; Android&nbsp; &nbsp;&nbsp; Apple",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://www.archiveexplorer.amdigital.co.uk/Default.aspx",
        moreInfo:
            "Learn more about AM Explorer Collections at BYU-Idaho: &nbsp;&nbsp; American History American Indian Histories and Cultures American Indian Newspapers American West China, America and the Pacific Colonial America Confidential Print: Latin America Defining Gender Eighteenth Century Drama Eighteenth Century Journals Empire Online First World War Foreign Office Files for China Frontier Life Jewish Life in America c.1654-1954Literary Manuscripts Berg Literary Manuscripts Leeds London Low Life Market Research and American Business Medieval Family Life Medieval Travel Migration to New Worlds Perdita Manuscripts Romanticism: Life, Literature and Landscape Shakespeare In Performance Slavery, Abolition and Social Justice The Nixon Years Travel Writing Victorian Popular Culture Virginia Company Archives",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://www.ancestryinstitution.com",
        moreInfo:
            "Billions of historical records, millions of family trees, and the AncestryDNA database, organized to provide individuals with insights about who they are and where they come from. Includes all available US Census.&nbsp; Access available On Campus Only&nbsp; &nbsp;&nbsp; Android app&nbsp;&nbsp; &nbsp;&nbsp; iOS app Users with an existing personal account log on here.",
    },
    {
        name: "Annual Reviews",
        description:
    ...
    },
    {
        ...
        url: "mailto: eResources@byui. edu?subject=ANSI Standards Request&body=Please provide the standard name and number you need.",
        moreInfo:
    ...
    url: "https://byui.idm.oclc.org/login?url=https://go.gale.com/ps/i.do?p=GDSC&sw=w&u=byuidaho&v=2.1&pg=BasicSearch&it=static&sid=bookmark-GDSC",
        moreInfo:
            "Topically-focused digital collections of historical documents that support the research and study needs of scholars and students at the college and university level.&nbsp; Lib Guide for Archives Unbound. Topics cover: American History British History European History Studies in: Business Economics Women Health Environment Religion Holocaust International Relations African Americans Native Americans Latin Americaand more",
    },
    {
        name: "ArkivDigital",
        description:
    ...
    url: "https://byui.idm.oclc.org/login?url=https://hv-proquest-com.byui.idm.oclc.org/historyvault/hv.jsp?pageid=whatsin&action=Civil%20Rights%20and%20the%20Black%20Freedom%20Struggle",
        moreInfo:
            "Search government records, organizational records, personal papers, and legal department files to find unique documentation and a variety of perspectives on the 20th century fight for freedom and social change.&nbsp; Contains three modules:&nbsp; Black Freedom Struggle in the 20th Century: Federal Government Records Black Freedom Struggle in the 20th Century: Organizational Records and Personal Papers, Part 1NAACP Papers: The NAACP's Major Campaigns--Legal Department FilesRead More&nbsp;| Browse the Collection&nbsp;| Search |&nbsp;",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://delrdiresearch.online/",
        moreInfo:
            "What does DELRdi do? Provides a body of knowledge for dance education spanning 9,000+ documents and citations Targets whatever impacts teaching and learning in or through dance Provides a history about dance education and the educational process Defines methodologies of research and research techniques Presents a description of the document, an abstract, or full text when copyright permission is granted Informs the user where to locate and access the original document What can DELRdi do for YOU? Offers researchers a showcase for their work Targets issues in your dance education research Provides a concentrated collection of Dance Education research and literature Presents the work of leading dance educators in the field Broadens the perspective of researchers in other fields that write about dance education Offers hours of fun and amusement to view the work of people you know or topics of interest",
    },
    {
        name: "Dance in Video",
        description:
    ...
    url: "https://byui.idm.oclc.org/login?url=https://search.proquest.com/pqdtglobal",
        moreInfo:
            "Subject coverage Arts Business &amp; Economics Education Humanities Social Sciences Behavioral Sciences Natural Sciences Mathematics &amp; Physical Sciences Health &amp; Medical Sciences",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://link-gale-com.byui.idm.oclc.org/apps/GDL?u=byuidaho&aty=ip",
        moreInfo:
            "Full List of Directories Included:&nbsp; Publishers Directory Directory of Publications and Broadcast Media Consultants &amp; Consulting Organizations Directory Encyclopedia of Association: International Organizations Encyclopedia of Association: National Organizations of the U. S. International Research Centers Directory National Directory of Nonprofit Organizations Biography &amp; Genealogy Master Index Directory of Special Libraries &amp; Information Centers",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://search.ebscohost.com/login.aspx?profile=ehost&defaultdb=nlebk,e867sww,e866sww,e864sww,e865sww,e868sww&authtype=sso&custid=s8406107",
        moreInfo:
            "Access over a million high-quality e Books and audio books in multiple disciplines from major academic publishers and university presses around the world. Selected from best-sellers, award winners, and specific titles for BYU-I courses.&nbsp; EBSCO Android Mobile app&nbsp;&nbsp; EBSCO iOS Mobile app",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://search.ebscohost.com/login.aspx?profile=ehost&defaultdb=egr&authtype=sso&custid=s8406107",
        moreInfo:
            "Offers access to 300,000+ essays; new ones are index &amp; added annually. Subjects Include: Anthropology Archaeology Art Economics Education Geography History Language Law Linguistics Literature Music Philosophy Political Science Psychology Religion Sociology Theatre",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://www.findmypast.co.uk/",
        moreInfo:
            "Find MyPast provides full access to England, Wales &amp; Scotland census records, easy-to-search birth, marriage and death records, the UK's largest collection of parish records, historical British newspapers and much more. AVAILABLE ON CAMPUS ONLY",
    },
    {
        name: "Fine Arts",
        description:
    ...
    },
    {
        ...
        subjects: ["General"],
        contentTypes: ["Full-Text Articles"],
    url: "https://search.ebscohost.com/login.aspx?authtype=sso&custid=s8406107&profile=eon&groupid=main",
        moreInfo: "",
    },
    {
        name: "Fold3",
    ...
    url: "https://byui.idm.oclc.org/login?url=https://go.gale.com/ps/start.do?p=PPGL&u=byuidaho",
        moreInfo:
            "A few of the hundreds of titles included:&nbsp; Foliage and Creative Design Computer Graphics for Landscape Architects Farming Fundamental Soil Science Gardens Illustrated Good Organic Gardening Horticulture, the Art of American Gardening Journal of Ecology Landscape Architecture Magazine Mother Earth NewsNOVAFarmer's AlmanacTrends in Plant ScienceHandbook of Flowers, Foliage, and Creative Design&nbsp;&nbsp;",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://search.alexanderstreet.com/glnd",
        moreInfo:
            "Volume 1: Africa Volume 2: South America, Mexico, Central America, and the Caribbean Volume 3: The United States and Canada Volume 4: Southeast Asia Volume 5: South Asia: The Indian Subcontinent Volume 6: The Middle East Volume 7: East Asia: China, Japan, and Korea Volume 8: Europe Volume 9: Australia and the Pacific Islands Volume 10: The World's Music: General Perspective and Reference Tools",
    },
    {
        name: "Gender Studies",
        description:
    ...
    url: "https://byui.idm.oclc.org/login?url=https://www.geoscienceworld.org/",
        moreInfo:
            "Geo Science World (GSW) is a resource for research and communications in the earth sciences built on a core database of peer-reviewed journals and integrated with the Geo Ref index. The organization gives global researchers a single point of access to dozens of full-text scholarly journals plus specialized searching capabilities and links to millions of relevant resources hosted elsewhere on the Web.&nbsp;",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://www.getabstract.com/portal/byui",
        moreInfo:
            "Get Abstract is the world's largest collection of business, leadership, and personal development summaries; with powerful 5-page / 10-minute read or listen summaries. Glean the key insights from 20,000+ of the best nonfiction and business books, articles, and video talks. GetAbstract is used by over one third of Fortune 100 companies to provide their employees and executives with the knowledge they need to succeed. Available as an app&nbsp;&nbsp; &nbsp;&nbsp; Android&nbsp; &nbsp;&nbsp; iOS&nbsp; Authenticates with BYU-I credentials.",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://search.proquest.com/globalwires?accountid=9817",
        moreInfo:
            "Global Breaking Newswires&nbsp; is an aggregated full-text news database with timely access to the best newswire (distributed) content available globally. Updated three times per day, it is a continually-growing archive of news content that may not be captured via traditional print sources or online sources. This resource is part of Pro Quest's&nbsp; Global Newsstream&nbsp; Collection.",
    },
    {
        name: "Global Issues",
        description:
    ...
    url: "https://byui.idm.oclc.org/login?url=https://www.guidestar.org/AdvancedSearch.aspx",
        moreInfo:
            "Guide Star provides data on every IRS registered non-profit organization. Discover the mission, legitimacy, impact, reputation, finances, programs, transparency, and governance of over 1.8 million non-profit organizations. Guide Star has merged with Foundation Center to provide users with the largest source of information about philanthropy and non-profit organizations.&nbsp;",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://app.knovel.com/web",
        moreInfo:
            "Knovel provides access to books, datasets, and reference works for engineering (electrical, mechanical, civil, materials, chemical, and biotechnology), chemistry and biochemistry, earth and environmental sciences, and more. Search through books and databases or use the interactive material property search, analytical tools, or equation solver that allow users to manipulate, analyze, and export data.&nbsp; Knovel To Go Mobile App for Android and Apple allows access to content saved by registered users.",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://onlinelibrary.wiley.com/topic/browse/000075",
        moreInfo:
            "Search these topics: Applied Linguistics Bilingualism Child Language Computational Linguistics Discourse &amp; Conversation Analysis Educational Linguistics English as a Second Language English Language Foreign Languages Special Topics French Grammars &amp; Dictionaries General &amp; Introductory Linguistics General Foreign Languages German Grammars &amp; Dictionaries Historical Linguistics History of English Language Intercultural Communication Italian Grammars &amp; Dictionaries Japanese Grammars &amp; Dictionaries Language &amp; Literature Language Teaching Linguistic Anthropology Linguistics Special Topics Modern &amp; World English Old &amp; Middle English Other Languages Phonetics Phonology Pragmatics Psycholinguistics Russian Grammars &amp; Dictionaries Second Language Acquisition Semantics Sign Language Sociolinguistics Spanish Grammars &amp; Dictionaries Speech Science Syntax Theoretical Linguistics",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://go.gale.com/ps/start.do?p=LT&u=byuidaho",
        moreInfo:
            "Legal Trac provides indexing for more than 1,200 major law reviews, legal newspapers, specialty publications, Bar Association journals, and international legal journals, including more than 200 titles in full text. The American Association of Law Libraries not only endorses Legal Trac, its special advisory committee selects, reviews, and enhances the content of this resource. The database offers coverage of federal and state cases, laws and regulations, legal practice and taxation, as well as British Commonwealth, European Union, and international law.",
    },
    {
    ...
    },
    {
        ...
        description:
            "<p>Study guides, flashcards, and practice questions for standardized exams including ACCUPLACER Exam, ACT Exam, AFCT, Alcohol and Drug Counselor Exam, ASVAB, ATI TEAS, CDL Exam – Air Brakes, CDL Exam – Passengers & School Bus, CDL Exam – Tank Vehicles, CDL Exam – Hazardous Materials, CDL Exam – Doubles and Triples, Certified Coding Associate Exam, Certified Medical Assistant Exam, Certified Midwives Exam, Certified Park and Recreation Professional Exam, CFP Exam, Civil Service Exam, Contractor’s General Building Exam, Corrections Officer Exam, GED Exam, GMAT, GRE, HiSET, Home Inspector Exam, HSPT, Journeyman Electrician Exam, Journeyman Plumber’s Exam, Loan Officer Exam, LSAT, Master Electrician Exam, Master Plumber’s Exam, MCAT, Mechanical Aptitude Test, Nail Technician Exam, NCLEX-PN, NCLEX-RN, PANCE, Police Exam, Postal Exam 474, Postal Exam 475, Postal Exam 476, Postal Exam 477, Praxis Core Academic Skills for Educators Exam, Praxis II Citizenship Education: Content Knowledge, PSAT, NMSQT, Real Estate Sales Exam, SAT Exam, SSAT Elementary Level, TABE, TASC, TEA Exam, TOEFL, HESI A2, CNA Exam, ACS General Chemistry Exam, Cosmetology Exam, BOC Athletic Training Exam, Esthetician Exam, Ham Radio Exam Extra, Ham Radio Exam General, Ham Radio Exam Technician, MBLEx, Private Investigator Exam, Wonderlic Basic Skills, Wonderlic Cognitive Ability, WorkKeys Exam, DAT, MAT, OAT, AFOQT, ASTB-E, California POST Exam, CJBAT, CLA Exam, CP Exam, FSOT, MPRE, OAR, SIFT, TCOLE Exam, ISEE Lower Level, ISEE Middle Level, ISEE Upper Level, TACHS Exam</p>",
        subjects: [
    ...
    url: "https://byui.idm.oclc.org/login?url=https://portal.mometrixelibrary.com/?__acct=12352",
        moreInfo:
            "Includes tests in these categories:&nbsp; Business Career College Admissions and Placement Construction and Industry Counseling and Social Work English Language Finance, Insurance, and Real Estate Graduate and Professional SchoolK-12Medical Professional Medical Technology Nursing Nutrition Personal Fitness Public Service and Legal Teaching",
    },
    {
        name: "MotoVisuals",
        description:
    ...
    url: "https://byui.idm.oclc.org/login?url=https://www.myheritage.com/",
        moreInfo:
            "Members of the LDS Church can receive free access thru their Family Search account. Find out how. World Vital Records and Family Link are now part of My Heritage.&nbsp;&nbsp;",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://video.alexanderstreet.com/channel/national-theatre-collection",
        moreInfo:
            "Made possible through a collaboration with the National Theatre. Partial List:&nbsp; Macbeth Othello Twelfth Night King Lear (Donmar Warehouse)Hamlet Coriolanus (Donmar Warehouse)Julius Caesar (Bridge Theatre)Romeo and Juliet (adapted for younger audiences)The Winter's Tale (adapted for younger audiences)MedeaAntigoneOne Man, Two GuvnorsShe Stoops to ConquerLondon AssuranceYerma (Young Vic)The Cherry OrchardThe Deep Blue SeaTranslationsA Streetcar Named Desire (Young Vic)Cat on a Hot Tin Roof (Young Vic)Les BlancsFrankensteinJane EyreTreasure IslandPeter PanSmall IslandConsentDarawonder. land",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://www.nytimes.com",
        moreInfo:
            "New users must Register here for a complimentary NYTimes pass account, provided by the Mc Kay Library.&nbsp; Link for existing BYU-I users. Available as an app: &nbsp; &nbsp;&nbsp; Android app&nbsp; &nbsp;&nbsp; iOS app&nbsp;&nbsp;&nbsp; Audio app for iOS (podcasts)",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://link.gale.com/apps/STND?u=byuidaho",
        moreInfo:
            "Gale One File News&nbsp; provides access to several thousand major U. S. regional, national, and local newspapers, as well as leading titles from around the world.&nbsp; Also included are thousands of images, radio and TV broadcasts, and transcripts.&nbsp; Search full-text articles by title, headline, date, author, newspaper section, or other fields.&nbsp; Browse Newspapers by Title",
    },
    {
        name: "NewsBank",
        description:
    ...
    url: "https://byui.idm.oclc.org/login?url=https://infoweb.newsbank.com/apps/news/advanced-search/?p=WORLDNEWS&f=advanced",
        moreInfo:
            "Includes:&nbsp; Idaho Statesman Financial Times (London)New York TimesUSA Today Washington Post And thousands more (Link to full list)Also includes Access Business News, Access International News, Access Military, Government, and Defense, Access Newswires &amp; Transcripts, and Acceda Noticias.",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://find.galegroup.com/dvnw/start.do?prodId=DVNW&userGroupName=byuidaho",
        moreInfo:
            "Includes archives of the following: (coverage dates vary)American Historical Periodicals British Library Newspapers Daily Mail Financial Times&nbsp; Nineteenth Century US Newspapers Nineteenth Century UK Periodicals Punch&nbsp; Burney Newspapers Collection Nichols Newspaper Collection The Sunday Times The Telegraph&nbsp; The Times The Times Literary Supplement",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://go.gale.com/ps/start.do?p=NCCO&u=byuidaho",
        moreInfo:
            "This database is a result of partnerships between Gale and almost 100 libraries in an effort to preserve and make available some of the most unique and pertinent monographs, newspapers, pamphlets, manuscripts, ephemera, maps, photographs, statistics, and other kinds of documents in both Western and non-Western languages in an effort to document this time of rapid change. Collections Included:&nbsp; Asia and the West British Politics and Society British Theatre, Music, and Literature Children's Literature and ChildhoodEurope and Africa, Colonialism and CultureEuropean Literature, the Corvey Collection, 1790-1840Maps and Travel LiteraturePhotographyReligion, Reform and SocietyScience, Technology, and Medicine: 1780-1925, Part IScience, Technology, and Medicine: 1780-1925, Part IIWomen and Transnational Networks&nbsp;",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://go.oreilly.com/byu-idaho",
        moreInfo:
            "This collection offers tens of thousands of some of the best technical books, videos, and training materials. Cover popular subjects such as: Software development User experience - UX/IAAutoCADBusiness &amp; Leadership Data Engineering &amp; Science Design Operating Systems Hardware development Math Science Engineering Programming languages Game development &amp; Gaming Cloud computing Security System administration Artificial intelligence - AI&nbsp; Travel &amp; Hobbies Career development Entrepreneurship Mobile appsand so much more! Features titles from O'Reilly Media, Wiley, Pearson, Routledge, IBM, For Dummies, and more.",
    },
    {
        name: "OmniFile",
        description:
    ...
    url: "https://byui.idm.oclc.org/login?url=https://oxfordre-com.byui.idm.oclc.org/religion/browse?submittedFilterId=by-availability&subSite=religion&pageSize=20&sort=titlesort&avail_3=unlocked&avail_4=free",
        moreInfo:
            "Subjects covered: Theology and Philosophy of Religion Islamic Studies Religion in America Indigenous Religions Judaism and Jewish Studies African Religions Christianity Religion and Artand much more",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://search.proquest.com/iipaft?accountid=9817",
        moreInfo:
            "Some periodical cover is abstract only; some is full text. Majority of records are from the most recent ten years of each journal. See title list. Subject coverage: Dance Theater Drama Film Mime / Pantomime Stagecraft Opera Puppetry Radio Television Storytelling Video Performance Arts Musical Theater Circus Performance Magic",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://www.proquest.com/philosophersindex/socialsciences/fromDatabasesLayer?accountid=9817",
        moreInfo:
            "Subject coverage Aesthetics Axiology Epistemology Ethics Logic Metaphilosophy Metaphysics Philosophical Anthropology Philosophy of Education Philosophy of History Philosophy of Language Philosophy of Religion Philosophy of Science Political Philosophy Social Philosophy",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://link.gale.com/apps/collection/8NJA/GDSC?u=byuidaho&sid=bookmark-GDSC",
        moreInfo:
            "The Rastafari have traditionally used the Written Word to express the hopes and aspirations of the exiled ascendants of the kidnapped Africans who were formerly enslaved in the European colonies of the Western world. The value of these publications to African-Caribbean history is in the vast treasure of largely untapped source materials on the evolution of a major social and religious movement and its key figures from the twentieth century into the twenty-first century. This resource is part of the Archives Unbound collection from Gale. Contents of Written Rastafari Archives ProjectWRAP Scope &amp; Content OverviewWRAP Collection Timeline and Inventory Volume 1: Rasta Voice (1971 - 1985)Index- Rasta Voice Newsletter: 27 Issues/6 Supplements - 399 Pages Volume 2A: JAHUGLIMAN (1978 - 1983)Index- JAHUGLIMAN Magazine: Series 1 (Jamaica): 3 Issues - 136 Pages Volume 2B: JAHUG (1991 - 2000)Index- JAHUG Magazine: Series 2 (United Kingdom): 7 Issues - 428 Pages Volume 3: Rastafari Speaks (1980 - 2003)Index- Rastafari Speaks Newspaper Series 1 (Trinidad): (1980 - 1983) - 11 Issues -222 Pages Index- Rastafari Speaks Newspaper Series 2 (Chicago): (1995 - 1997) - 4 Issues - 84 Pages Index- Rastafari Speaks Newspaper Series 3 (Chicago): (2002 - 2003) - 4 Issues - 120 Pages Volume 4: Boboshanti Ephemerals (1982 - 2008)Index- Boboshanti Ephemerals: 28 Items - 260 Pages Volume 5: Rastafari International News (1987 - 1989)Index- Rastafari International News Newspaper: 8 Issues - 90 Pages Volume 6: Rasta Vibrations (1993 - 1997)Index- Rasta Vibrations Magazine: 4 Issues - 128 Pages / 1 Booklet - 40 Pages Volume 7A: Reggae Roots (1991 - 1995)Index- Reggae Roots Magazine Series 1:14 Issues - 612 Pages Volume 7B: Reggae Roots International (1996 - 1998)Index- Reggae Roots International Newspaper Series 2: 7 Issues - 196 Pages Volume 7C: Rootz Reggae &amp; Kulcha (1998 - 2014)Index- Rootz Reggae &amp; Kulcha Magazine Series 3: 34 Issues - 1336 Pages/1 Booklet - 40 Pages Volume 8: Thunder Magazine (2010 - 2014)Index- Thunder Magazine: 4 Issues - 142 Pages&nbsp;",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://refworks.proquest.com/",
        moreInfo:
            "Ref Works is a web-based bibliography and database manager that allows users to create their own personal database by importing references from text files or online databases and other various sources. Users then use these references in writing papers; Ref Works will automatically format the paper and the bibliography in seconds.",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://rsc.byu.edu/",
        moreInfo:
            "Access the Religious Educator Journal available with a one-year embargo; e Books (some by purchase only); podcasts and conference proceedings. Audio and Video include:&nbsp; Y Religion Podcast Roundtable Discussions Church History Symposium Sidney B. Sperry Symposium History of the Religious Studies Center",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://search.proquest.com/pqrl?accountid=9817",
        moreInfo:
            "Pro Quest Research Library provides one-stop access to thousands of full-text periodicals from one of the broadest, most inclusive general reference databases Pro Quest has to offer. Search from a highly-respected, diversified mix of scholarly journals, professional and trade publications, and magazines covering over 150 subjects and topics.&nbsp;&nbsp;",
    },
    {    
    ...
    url: "https://byui.idm.oclc.org/login?url=https://search.ebscohost.com/login.aspx?profile=ehost&defaultdb=ram&authtype=sso&custid=s8406107",
        moreInfo:
            "&nbsp; RILM covers traditional music, popular music, jazz, classical music, and related musicology subjects. Coverage is from the 1800s to the present. In addition to journal articles, RILM covers a variety of publications and media types including: Books and monographs Bibliographies Catalogues Critical editions of music Digital media Dissertations Electronic resources Essay collections Ethnographic recordings Films and videos Iconographies Reference materials Reviews Sound recordings Technical drawings of instruments",
    },
    {
        name: "RISM Catalog",
        description:
    ...
    url: "https://byui.idm.oclc.org/login?url=https://go-gale-com.byui.idm.oclc.org/ps/start.do?p=SAS&u=byuidaho",
        moreInfo:
            "The four parts to this collection cover: Debates over Slavery and Abolition Slave Trade in the Atlantic World The Institution of Slavery Age of Emancipation Focused originally on the United States in 2005, the collection was revised to include more international coverage.",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://research.ebsco.com/c/m65exo/topics/categories/TOPIC-0000156095?isDashboardExpanded=true",
        moreInfo:
            "The SWOT Analysis data indexed in EBSCOhost is provided by Market Line, a leading provider of online database and analysis services for key industry sectors.&nbsp; Market Line provides unbiased expert analysis and in-depth forecasts for seven industry sectors: Automotive Consumer Markets Energy Financial Services Pharmaceuticals and Healthcare Technology Transport and Logistics For more information about SWOT and Market Line, please visit http://marketline. com.",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://www.proquest.com/lion/docview/2343198855?accountid=9817",
        moreInfo:
            "9,000 poems by some of the most influential African American poets including: James Weldon Johnson Georgia Douglas Camp Johnson Claude Mc Kay Langston Hughes Jean Toomer Arna Bontemps Sterling Brown Imamu Amiri Baraka Etheridge Knight Audre Lorde Sonia Sanchez AiRita Dove Yusef Komunyakaa&nbsp; and many young writers who have gained recognition through national poetry awards and printing in anthologies",
    },
    {
    ...
    },
    {
        ...
        moreInfo:
            "New users must Register here&nbsp; for a WSJ Premium account, provided by the Mc Kay Library.&nbsp; Access must be renewed periodically. Link for Existing BYU-I users.&nbsp; Available as an app: &nbsp; Android app&nbsp; &nbsp;&nbsp; iOS app Access to&nbsp; WSJ archives 1889-2011",
    },
    {
    ...
    url: "https://byui.idm.oclc.org/login?url=https://onlinelibrary.wiley.com",
        moreInfo:
            "Find e Books in these subject areas: &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Available as an app: &nbsp; &nbsp; Android app&nbsp; &nbsp; iOS app&nbsp; Agriculture, Aquaculture &amp; Food Science Architecture &amp; Planning Art &amp; Applied Business, Economics, Finance &amp; Accounting Chemistry Computer Science &amp; Information Technology Earth, Space &amp; Environmental Sciences Humanities Law &amp; Criminology Life Sciences Mathematics &amp; Statistics Medicine Nursing, Dentistry &amp; Healthcare Physical Sciences &amp; Engineering Psychology Social &amp; Behavioral Sciences Veterinary Medicine",
    },
    {
