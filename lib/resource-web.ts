...
{
    name: "David O. McKay Library Research Starter",
    description: "<p>The David O. McKay Library serves university and community patrons with a vast book collection, hundreds of databases, and much more. The building also houses university archives, a special exhibition area, and instructional technology labs.</p>",
    subjects: ["General"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/begin-your-research",
    moreInfo: "David O. McKay Library Research Starter HOME / BEGIN YOUR RESEARCH Begin Your Research: Interactive Module "Begin Your Research" is a derivative of "The Research Process" by the IUPUI Library used under CC BY-NC-SA . "Begin Your Research" is licensed under CC BY-NC-SA by the BYU-Idaho David O. McKay Library.",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "Begin-Your-Research",
    description: "<p>Begin-Your-Research Begin-Your-Research Internet connection lost. Please check your connection. Retry</p>",
    subjects: ["General"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/begin-your-research/story.html",
    moreInfo: "Begin-Your-Research Begin-Your-Research Internet connection lost. Please check your connection. Retry",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},

{
    name: "David O. McKay Library Policies",
    description: "<p>The David O. McKay Library serves university and community patrons with a vast book collection, hundreds of databases, and much more. The building also houses university archives, a special exhibition area, and instructional technology labs.</p>",
    subjects: ["Circulation", "Special Collections", "Interlibrary Loan"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/contact",
    moreInfo: "David O. McKay Library Policies Skip to main content HOME / CONTACTS GENERAL CONTACT INFORMATION Office Phone# Office Phone# Circulation Desk (208) 496-9522 Library Administration (208) 496-9501 Digitization Center (DCAM) (208) 496-9521 Mac Lab (208) 496-9550 Interlibrary Loan (208) 496-9524 Special Collections (208) 496-9540 Ask a Librarian (SMS text) (208) 782-4542 Librarians by Subject All Library Employees",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "David O. McKay Library Equella Digital Asset Management",
    description: "<p>The David O. McKay Library serves university and community patrons with a vast book collection, hundreds of databases, and much more. The building also houses university archives, a special exhibition area, and instructional technology labs.</p>",
    subjects: ["General"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/equella",
    moreInfo: "David O. McKay Library Equella Digital Asset Management HOME / EQUELLA DIGITAL ASSET MANAGEMENT EQUELLA Equella is BYU-Idaho's Content Management System and allows you to host a variety of content. Microsoft Office & PDF files Images Web Pages Use the button below to schedule a consultation with an Equella Expert. GO TO EQUELLA SCHEDULE NOW Equella Sync is a desktop application to help you manage Equella content. Learn more by watching the introduction video then request installation from the FTC at 208-496-7230.",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "search devotionals",
    description: "<p>search devotionals Search Devotionals:</p>",
    subjects: ["General"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/equella/search.html",
    moreInfo: "search devotionals Search Devotionals:",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "David O. McKay Library Mission Statement",
    description: "<p>David O. McKay Library Mission Statement HOME / Special Collections Digital Objects Search Special Collections All Collections</p>",
    subjects: ["Library Mission", "Special Collections"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/equella/searchEquellaSPC.html",
    moreInfo: "David O. McKay Library Mission Statement HOME / Special Collections Digital Objects Search Special Collections All Collections",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "David O. McKay Library Faculty Resources",
    description: "<p>The David O. McKay Library serves university and community patrons with a vast book collection, hundreds of databases, and much more. The building also houses university archives, a special exhibition area, and instructional technology labs.</p>",
    subjects: ["Instruction", "Faculty Resources", "Orientation"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/faculty-resources",
    moreInfo: "David O. McKay Library Faculty Resources HOME / FACULTY RESOURCES Faculty Resources LIBRARY INSTRUCTION Schedule a class orientation or assign students to attend a session outside of class. During the orientation a professional librarian will introduce your class to the research tools and resources available through the David O. McKay Library. LEARN MORE SUBJECT LIBRARIANS A subject librarian has been assigned to each department on campus. Your subject librarian can help you find and order library materials. LEARN MORE EQU...",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "David O. McKay Library Journals",
    description: "<p>David O. McKay Library Journals HOME / JOURNALS McKay Library Contact Information JOURNALS BY TITLE Journal Lookup by DOI or PMID Browse Journals by Discipline</p>",
    subjects: ["General"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/journals",
    moreInfo: "David O. McKay Library Journals HOME / JOURNALS McKay Library Contact Information JOURNALS BY TITLE Journal Lookup by DOI or PMID Browse Journals by Discipline",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "David O. McKay Library Mission Statement",
    description: "<p>David O. McKay Library Mission Statement ASK A LIBRARIAN chat loading... Go to the Library home page Need more help? Schedule Appointment Call: 208-496-9522 Text: 208-782-4542</p>",
    subjects: ["Library Mission"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/library-chat",
    moreInfo: "David O. McKay Library Mission Statement ASK A LIBRARIAN chat loading... Go to the Library home page Need more help? Schedule Appointment Call: 208-496-9522 Text: 208-782-4542",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "David O. McKay Library Library Instruction",
    description: "<p>The David O. McKay Library serves university and community patrons with a vast book collection, hundreds of databases, and much more. The building also houses university archives, a special exhibition area, and instructional technology labs.</p>",
    subjects: ["Instruction", "Information Literacy"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/library-instruction",
    moreInfo: "David O. McKay Library Library Instruction HOME / REQUEST LIBRARY INSTRUCTION The David O. McKay Library offers information literacy instruction in developing the skills needed to locate, analyze, and evaluate information. When the remodel is complete we will be able to accommodate classes in the library, however, during the remodel a librarian can be scheduled to come to your classroom. REQUEST LIBRARY INSTRUCTION In addition to face-to-face instruction, we can support your on-campus, online, or blended class through a variety of methods. If you would help with any of the following services, please contact your Subject Librarian . Research Guides Research Guides provide links to selected library sources, videos, and other databases for a specific class or subject area. RESEARCH GUIDES Instructional Tutorials...",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "Mac Lab | McKay Library",
    description: "<p>The Mac Lab homepage. Check out our 3D Printers, equipment rentals, and more.</p>",
    subjects: ["Printing Services", "Equipment Checkout"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/maclab",
    moreInfo: "Mac Lab | McKay Library The Mac Lab SEE All HOURS WHAT ARE YOU LOOKING FOR? Printing Adobe Help Equipment Checkout Virtual Reality Workshops Cricut EQUIPMENT See All Canon EOS R100 2 Week Checkout Headphones 1 Day Checkout Wacom Tablets 3 Day Checkout GoPros 2 Week Checkout Calculators 2 Week Checkout UPCOMING EVENTS See All",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
...
},
{
    ...
    moreInfo: "VR - Mac Lab | McKay Library Virtual Reality We offer access to VR apps such as Organon, Escosphere, BRINK Traveler, and more. AVAILABLE APPS Organon Education Mondly Education Anne Frank House Documentary On the Morning Documentary Home After War Documentary Notes on Blin dness Documentary Traveling While Black Documentary Wander Explore National Geo graphic Explore Mission:ISS Explore Ecosphere Explore Lost Recipes Explore Tilt Brush Explore Healium Explore Keep Talking and Nobody Explodes Video Game Beat Saber Video Game FREQUENTLY ASKED QUESTIONS How can I check out the VR headset? Come to the Mac Lab and check it out for free! It has a 24 hour checkout period. Am I able to screen cast while playing VR? Yes! Just ask one of the employees, and we can show you how to screen cast.",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "David O. McKay Library Maps",
    description: "<p>David O. McKay Library Maps HOME / MAPS MAPS FIRST FLOOR SECOND FLOOR THIRD FLOOR CAMPUS MAP FIRST FLOOR POINTS OF INTEREST</p>",
    subjects: ["General"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/maps",
    moreInfo: "David O. McKay Library Maps HOME / MAPS MAPS FIRST FLOOR SECOND FLOOR THIRD FLOOR CAMPUS MAP FIRST FLOOR POINTS OF INTEREST",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "David O. McKay Library Maps 2nd Floor",
    description: "<p>David O. McKay Library Maps 2nd Floor HOME / MAPS - 2ND FLOOR MAPS FIRST FLOOR SECOND FLOOR THIRD FLOOR CAMPUS MAP SECOND FLOOR POINTS OF INTEREST</p>",
    subjects: ["General"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/maps/second-floor",
    moreInfo: "David O. McKay Library Maps 2nd Floor HOME / MAPS - 2ND FLOOR MAPS FIRST FLOOR SECOND FLOOR THIRD FLOOR CAMPUS MAP SECOND FLOOR POINTS OF INTEREST",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
{
    name: "David O. McKay Library Maps - 3rd Floor",
    description: "<p>David O. McKay Library Maps - 3rd Floor HOME / MAPS - 3RD FLOOR MAPS FIRST FLOOR SECOND FLOOR THIRD FLOOR CAMPUS MAP THIRD FLOOR Currently Closed and Under Renovation</p>",
    subjects: ["General"],
    contentTypes: ["Web Page"],
    url: "https://library.byui.edu/maps/third-floor",
    moreInfo: "David O. McKay Library Maps - 3rd Floor HOME / MAPS - 3RD FLOOR MAPS FIRST FLOOR SECOND FLOOR THIRD FLOOR CAMPUS MAP THIRD FLOOR Currently Closed and Under Renovation",
    accessNote: "Available to all BYU-Idaho students, faculty, and staff."
},
]
